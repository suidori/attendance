...
<div class="w-96 bg border border-black"><input  type="text" name="" id="" placeholder="강의명 또는 이름검색" 
    class="w-11/12 px-3 pt-1 pb-1 "><span class=" ml-2 cursor-pointer">＠</span></div>
</div>
<br>
<div class="">
    <div class="ml-24">
