      ...
      <div class="w-[60%] p-4 flex flex-col items-center justify-center">
        <div class="space-y-3">
          ...
          <div class="flex justify-between text-center">
            ...
            <input
              class="p-3 mb-5 ml-5 transition duration-200 border-b border-gray-400 w-80 focus:outline-none"
              type="text"
              name="userid"
              id="userid"
          ...
          <p>
            PASSWORD
            <input
              class="p-3 ml-5 transition duration-200 border-b border-gray-400 w-80 focus:outline-none"
              type="password"
              name="password"
              id="password"
              v-model="password"
