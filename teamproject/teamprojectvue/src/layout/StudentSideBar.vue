<template>
  <div class="w-40 rounded-sm">
    ...
    <div class="bg-blue-300 h-[650px]">
      ...
      <div @click="logout" class="font-[GmarketSansMedium]   border-gray-300 bg-slate-100 m-3 mt-24 rounded-md cursor-pointer hover:bg-red-400"><span class="p-2 pb-1 flex justify-center ">로그아웃</span></div>
    </div>
  </div>
</template>
